...
function getXml(pharmacy) {
  const xml = `<?xml version="1.0" encoding="UTF-8" standalone="no" ?>${convert.js2xml({ pharmacy }, { compact: true })}`;
  return xml;
}

async function putRecordAsXml(record) {
  return new Promise((resolve, reject) => {
    request(putOptions(record, 'application/xml', getXml), (error, response, body) => {
